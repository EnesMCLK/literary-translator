...
const STRINGS_REGISTRY: Record<string, any> = {
  tr: {
    ...
    title: "Literary Translator", description: "Profesyonel Edebi Çeviri Motoru", settingsTitle: "AYARLAR VE KONFİGÜRASYON",
  ...
  en: {
    ...
    title: "Literary Translator", description: "Professional Literary Translation Engine", settingsTitle: "SETTINGS & CONFIG",
  ...
  zh: {
    ...
    title: "文学翻译官", description: "专业文学翻译引擎", settingsTitle: "设置与配置",
  ...
  fr: {
    ...
    title: "Literary Translator", description: "Moteur de Traduction Littéraire", settingsTitle: "CONFIGURATION",
  ...
  de: {
    ...
    title: "Literary Translator", description: "Professionelle Literatur-Engine", settingsTitle: "EINSTELLUNGEN",
  ...
  es: {
    ...
    title: "Literary Translator", description: "Motor Literario Profesional", settingsTitle: "AJUSTES",
  ...
  ru: {
    ...
    title: "Литературный Переводчик", description: "Профессиональный движок", settingsTitle: "НАСТРОЙКИ",
  ...
  it: {
    ...
    title: "Literary Translator", description: "Motore di Traduzione Professionale", settingsTitle: "IMPOSTAZIONI",
  ...
  ja: {
    ...
    title: "Literary Translator", description: "プロフェッショナル文学翻訳エンジン", settingsTitle: "設定と構成",
  ...
  ko: {
    ...
    title: "Literary Translator", description: "전문 문학 번역 엔진", settingsTitle: "설정 및 구성",
  ...
  ar: {
    ...
    title: "المترجم الأدبي", description: "محرك ترجمة أدبية احترافية", settingsTitle: "الإعدادات",
  ...
  pt: {
    ...
    title: "Literary Translator", description: "Motor de Tradução Literária Profissional", settingsTitle: "CONFIGURAÇÕES",
  ...
  nl: {
    ...
    title: "Literary Translator", description: "Professionele Literaire Vertaalmachine", settingsTitle: "INSTELLINGEN",
  ...
  pl: {
    ...
    title: "Literary Translator", description: "Profesjonalny silnik tłumaczeń literackich", settingsTitle: "USTAWIENIA",
  ...
  hi: {
    ...
    title: "Literary Translator", description: "पेशेवर साहित्यिक अनुवाद इंजन", settingsTitle: "सेटिंग्स और कॉन्फ़िگرेशन",
  ...
  vi: {
    ...
    title: "Literary Translator", description: "Công cụ dịch thuật văn học chuyên nghiệp", settingsTitle: "CÀI ĐẶT",
      ...
      <aside className={`fixed top-0 right-0 h-full w-80 bg-white dark:bg-slate-900 z-[80] shadow-2xl transition-transform duration-300 transform border-l border-slate-200 dark:border-slate-800 ${isRightDrawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
            ...
            {/* HTML Tags Section - Restored and Localized */}
            <div className="space-y-4">
